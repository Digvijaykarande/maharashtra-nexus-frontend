...
export default async function RootTownDetailPage({ params }) {
  // Destructure the townSlug directly from your new root folder configuration
            ...
            <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-50 min-h-[450px] shadow-sm">
              <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none opacity-40">
                <div className="text-center">
                  ...
                  <p className="mt-4 text-sm font-medium text-slate-500">Loading Map Component Layer...</p>
                </div>
              </div>
              <div className="relative z-10 w-full h-[450px]">
                <VillageMapWrapper lat={town.latitude || 19.7515} lng={town.longitude || 75.7139} />
              </div>
            </div>
          </Container>
        </section>
